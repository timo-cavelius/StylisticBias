...
X-axis: average signed shift across models (mean Δ)
Y-axis: mean absolute shift across models (mean |Δ|)
One dot per scenario, coloured by category.
Outlier labels shown for points far from the origin.

Output: output/evaluation/eval_charts/scenario_sensitivity.png

Usage:
  python3 src/scenario_sensitivity.py
"""

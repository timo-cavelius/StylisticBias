...
Line chart: one line per model, x-axis = 25 scenarios (ordered and grouped
by category), coloured background bands per category, category labels at the
bottom of each band.

Input : output/evaluation/model_comparison_<latest>/scenario_comparison.csv
Output: output/evaluation/eval_charts/model_mean_across_scenarios.png

Usage:
  python3 src/model_mean_across_scenarios.py
"""
